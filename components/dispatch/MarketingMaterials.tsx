...
const templateFields: Record<string, FieldDef[]> = {
  menuPrices: [
    ...
    { id: "headline",     label: "Offer title",       placeholder: "e.g. Same food. Lower price.",                                          maxLength: 35  },
    { id: "bodyCopy",     label: "Offer description", placeholder: "e.g. Apps charge 30% extra. Order direct and pay our real menu prices.", maxLength: 120, multiline: true },
  ],
  discount: [
    { id: "businessName", label: "Business name",      placeholder: "e.g. La Familia Katonah" },
    { id: "headline",     label: "Title",              placeholder: "e.g. 15% Off your next order",     maxLength: 50 },
    { id: "details",      label: "Promo code",         placeholder: "e.g. SHIPDAY15",                  maxLength: 20 },
    { id: "termsText",    label: "Terms & expiration", placeholder: "e.g. T&Cs apply · Valid until Dec 31, 2024", maxLength: 60 },
    { id: "orderUrl",     label: "QR code link",       placeholder: "e.g. order.yourstore.com" },
  ],
  freeItem: [
    { id: "businessName", label: "Business name",      placeholder: "e.g. La Familia Katonah" },
    { id: "headline",     label: "Offer title",        placeholder: "e.g. Get free garlic knots on orders over $20", maxLength: 40 },
    { id: "details",      label: "Promo code",         placeholder: "e.g. OFF20",                     maxLength: 20 },
    { id: "termsText",    label: "Terms & expiration", placeholder: "e.g. T&Cs apply · Offer ends 30.05.26", maxLength: 60 },
    { id: "orderUrl",     label: "QR code link",       placeholder: "e.g. order.yourstore.com" },
  ],
};
